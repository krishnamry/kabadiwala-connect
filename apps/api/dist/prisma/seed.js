...
async function main() {
    ...
    await prisma_1.prisma.scrapItem.deleteMany();
    await prisma_1.prisma.pickup.deleteMany();
    await prisma_1.prisma.kabadiwalaProfile.deleteMany();
    await prisma_1.prisma.user.deleteMany();
    await prisma_1.prisma.scrapRate.deleteMany();
    ...
    for (const rate of rates) {
        await prisma_1.prisma.scrapRate.create({ data: rate });
    }
