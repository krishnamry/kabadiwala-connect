...
const translations: Record<Language, Record<string, string>> = {
  ...
  hi: {
    ...
    recyclerCardDesc: 'आने वाले लॉट की जांच व बोली (स्वीकार/अस्वीकार), क्यूआर स्कैन, लाइव दाम प्रसारण और सीपीसीबी फॉर्म-२ एवं फॉर्म-६ रिपोर्ट।',
    ...
    lotTypeSelection: '१. लॉट प्रकार चुनें',
    singleMaterialLot: 'एकल सामग्री लॉट',
    customMixedLot: 'कस्टम मिक्स्ड लॉट (मिश्रित कबाड़)',
    uploadPhotoLabel: '२. कबाड़ की फोटो लें या अपलोड करें',
    tapToSnapPhoto: 'कैमरा खोलें या फोटो खींचें',
    photoCapturedMsg: 'फोटो कैप्चर एवं सत्यापित (1080p)',
    selectScrapCategory: '३. ई-कचरा श्रेणी चुनें',
    approxWeightLabel: '४. अनुमानित वजन दर्ज करें (किग्रा)',
    minWeightNote: 'न्यूनतम ०.५ किग्रा',
    lotLocationLabel: '५. लॉट हस्तांतरण / कबाड़ गोदाम का स्थान',
    ...
    biddingRule: 'रीसायकलर बोली नियम: मांग मूल्य का न्यूनतम ५०%',
    ...
    step3Copper: 'कदम ३: बिना जलाए (कोल्ड स्ट्रिपिंग) तांबे की तार छीलें',
    step3CopperDesc: 'मोटर का तांबा बिना आग लगाए वायर कटर से निकालें (₹४८०/किग्रा)।',
    ...
    incomingLotsDesc: 'सत्यापित कबाड़ीवालों द्वारा जमा किए गए डिजिटल लॉट पर बोली लगाएं। वैध बोली मांग मूल्य का न्यूनतम ५०% होनी चाहिए।',
    allLots: 'सभी लॉट',
  ...
  mr: {
    ...
    recyclerCardDesc: 'येणाऱ्या लॉटची तपासणी व लिलाव (स्वीकार/नकार), क्यूआर स्कॅन, थेट दर प्रसारण आणि सीपीसीबी फॉर्म-२ व फॉर्म-६ अहवाल.',
    ...
    lotTypeSelection: '१. लॉट प्रकार निवडा',
    singleMaterialLot: 'एकच प्रकारचा लॉट',
    customMixedLot: 'कस्टम मिक्स्ड लॉट (मिश्रित भंगार)',
    uploadPhotoLabel: '२. भंगाराचा फोटो घ्या किंवा अपलोड करा',
    tapToSnapPhoto: 'कॅमेरा उघडा किंवा फोटो काढा',
    photoCapturedMsg: 'फोटो कॅप्चर व प्रमाणित (1080p)',
    selectScrapCategory: '३. वस्तू प्रकार निवडा',
    approxWeightLabel: '४. अंदाजे वजन टाका (कि.ग्रा.)',
    minWeightNote: 'किमान ०.५ कि.ग्रा.',
    lotLocationLabel: '५. लॉट हस्तांतरण / भंगार गोदामाचे ठिकाण',
    ...
    biddingRule: 'रीसायकलर बोली नियम: मागणी मूल्याच्या किमान ५०%',
    ...
    step3Copper: 'टप्पा ३: विना जाळता (थंड पद्धतीने) तांब्याची तार काढा',
    ...
    incomingLotsDesc: 'प्रमाणित कबाडीवाल्यांनी सादर केलेल्या डिजिटल लॉटवर बोली लावा. वैध बोली मागणी मूल्याच्या किमान ५०% असावी.',
    allLots: 'सर्व लॉट',
...
const PHRASE_ALIASES: Record<string, { hi: string; mr: string }> = {
  ...
  'min 50% of ask value': { hi: 'मांग मूल्य का न्यूनतम ५०%', mr: 'मागणी मूल्याच्या किमान ५०%' },
  ...
  'layer 1 verification: citizen handover otp': {
    hi: 'स्तर १ सत्यापन: नागरिक हस्तांतरण ओटीपी',
    mr: 'टप्पा १ पडताळणी: नागरिक हस्तांतरण ओटीपी'
  },
  'layer 1 verified: physical doorstep handover confirmed': {
    hi: 'स्तर १ सत्यापित: घर पर प्रत्यक्ष कबाड़ हस्तांतरण संपन्न',
    mr: 'टप्पा १ प्रमाणित: प्रत्यक्ष घरगुती संकलन पूर्ण'
  },
  'layer 2: ai verified': { hi: 'स्तर २: एआई द्वारा सत्यापित', mr: 'टप्पा २: एआई द्वारे प्रमाणित' },
  'layer 3: weighbridge handover verified': {
    hi: 'स्तर ३: धर्मकांटा / वेईब्रिज हस्तांतरण सत्यापित',
    mr: 'टप्पा ३: वजनकाटा हस्तांतरण प्रमाणित'
  },
  ...
  'q2-2026 batch': { hi: 'तिमाही २ - २०२६ बैच', mr: 'तिमाही २ - २०२६ बॅच' },
  ...
  'equivalent to 4 trees': { hi: '४ वृक्षों के बराबर', mr: '४ झाडांच्या बरोबर' },
