              ...
              {mobileScreen === 'collector' && (
                <div className="space-y-4 pb-20">
                  ...
                  <Card interactive elevation="flat" className="space-y-3">
                    <div className="flex items-start gap-3">
                      <div className="w-16 h-16 rounded-xl bg-slate-800 shrink-0 overflow-hidden relative border border-slate-700">
                        ...
                        <div className="w-full h-full bg-gradient-to-br from-emerald-900 via-slate-900 to-amber-900 flex items-center justify-center text-[9px] font-mono text-emerald-400 font-bold p-1 text-center">
                          PCB FR-4
                        </div>
                      </div>
                    ...
                    <div className="pt-2 border-t border-slate-100 dark:border-slate-800/80 flex items-center justify-between">
                      ...
                      <span className="text-[11px] font-mono text-slate-400">12m left</span>
                    </div>
                  </Card>
                  ...
                  <Card interactive elevation="flat" className="space-y-3">
                    <div className="flex items-start gap-3">
                      <div className="w-16 h-16 rounded-xl bg-slate-800 shrink-0 overflow-hidden relative border border-slate-700">
                        <div className="w-full h-full bg-gradient-to-br from-orange-800 via-amber-950 to-slate-900 flex items-center justify-center text-[9px] font-mono text-orange-300 font-bold p-1 text-center">
                          Cu Wire
                        </div>
                      </div>
                      <div className="flex-1 min-w-0">
                    ...
                    <div className="pt-2 border-t border-slate-100 dark:border-slate-800/80 flex items-center justify-between">
                      ...
                      <span className="text-[11px] font-mono text-slate-400">1h left</span>
                    </div>
                  </Card>
                </div>
              )}
                ...
                <div className="space-y-4 pb-20">
                  <div className="flex items-center justify-between pt-2">
                    <div>
                      ...
                      <p className="text-xs text-slate-400">Updated: 24 May, 10:09 AM</p>
                    </div>
                    <VoicePill
                  ...
                  <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar py-1">
                    {['All', 'PCBs', 'Cables', 'Batteries'].map((cat, idx) => (
                      <span
                        key={cat}
                  ...
                  {/* Rate Card 1 */}
                  <div className="bg-[#111625] p-4 rounded-2xl border border-slate-800 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-slate-400">Printed Circuit Boards</span>
                  ...
                  <div className="bg-[#111625] p-4 rounded-2xl border border-slate-800 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-slate-400">Copper Wires & Cables</span>
                      <span className="text-xs font-mono font-bold text-emerald-400">
                        +₹25 (▲ 5.2%)
                      </span>
                    </div>
              ...
              {mobileScreen === 'citizen' && (
                <div className="space-y-4 pb-20">
                  ...
                  <Card elevation="flat" className="space-y-3">
                    <div className="w-full h-32 rounded-xl bg-slate-800 overflow-hidden relative border border-slate-700 flex items-center justify-center">
                      <div className="text-center p-3">
                        ...
                        <p className="text-[11px] text-slate-300 mt-2">Broken Laptop Motherboard</p>
                      </div>
                    </div>
                  ...
                  <Button variant="emerald" fullWidth size="md">
          ...
          >
            <div className="grid grid-cols-2 gap-3 py-2">
              ...
              >
                ...
                <p className="text-[10px] text-slate-400">Unlock unlimited bids</p>
              </Card>
              ...
              >
                ...
                <p className="text-[10px] text-slate-400">Authorized smelters</p>
              </Card>
